...
},{}],"node_modules/portal-vue/dist/portal-vue.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*
    portal-vue
...
},{}],"src/js/section-picker.component.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    ...
    onRemoveSection: function onRemoveSection(section) {
      this.$emit('remove-section', section);
    }
  }
};
exports.default = _default;
        var $d9a7ce = exports.default || module.exports;
      
      if (typeof $d9a7ce === 'function') {
        $d9a7ce = $d9a7ce.options;
      }
    
        /* template */
        Object.assign($d9a7ce, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "section-picker" } }, [
    _c(
      "div",
            ...
            _c("div", { staticClass: "buttons" }, [
                ...
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      _vm.onClick(section.key)
                    }
                  }
                },
                [
                  _c("span", [_vm._v("Random")]),
                  _vm._v(" "),
              ...
              _c(
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      _vm.onRemoveSection(section.key)
                    }
                  }
                },
                [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d9a7ce', $d9a7ce);
          } else {
            api.reload('$d9a7ce', $d9a7ce);
          }
        }
...
exports.default = _default;
        var $b64e09 = exports.default || module.exports;
      
      if (typeof $b64e09 === 'function') {
        $b64e09 = $b64e09.options;
      }
    
        /* template */
        Object.assign($b64e09, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "survey" }, [_vm._t("default")], 2)
}
var staticRenderFns = []
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b64e09', $b64e09);
          } else {
            api.reload('$b64e09', $b64e09);
          }
        }
...
var _sectionPicker = _interopRequireDefault(require("./section-picker.component"));

var _survey = _interopRequireDefault(require("./survey.component"));
...
var _default = {
  name: 'app-component',
  components: {
    SectionPicker: _sectionPicker.default,
    SurveyComponent: _survey.default
  },
  data: function data() {
    return {
      survey: {
  ...
  computed: {
    surveyComputed: function surveyComputed() {
      var _this = this;

      return "\n        ".concat(Object.keys(this.survey).map(function (key) {
    ...
    sectionKeys: function sectionKeys() {
      ...
      return Object.keys(this.survey).map(function (key) {
        return {
          key: key,
          description: _this2.survey[key].description,
          active: !!_this2.survey[key].value.length,
          title: _this2.survey[key].title
        };
      });
    }
  },
  methods: {
    toggleSection: function toggleSection(section) {
      var newValue = this.wittyStuff[section][Math.floor(Math.random() * this.wittyStuff[section].length)];
...
exports.default = _default;
        var $3371ec = exports.default || module.exports;
      
      if (typeof $3371ec === 'function') {
        $3371ec = $3371ec.options;
      }
    
        /* template */
        Object.assign($3371ec, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    [
      ...
      _c("div", { staticClass: "container" }, [
        _c(
          ...
          [
            _c("survey-component", [
              _c("div", {
                attrs: { id: "inner" },
                domProps: { innerHTML: _vm._s(_vm.surveyComputed) }
              })
            ])
          ],
          1
        ...
        _c(
          ...
          [
            _c("section-picker", {
              attrs: { sections: _vm.sectionKeys },
              on: {
                "section-clicked": _vm.toggleSection,
      ...
      _vm._v(" "),
      _c("portal-target", { attrs: { name: "mobileSectionPicker", slim: "" } })
    ],
    1
  )
}
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { attrs: { id: "mobile-message" } }, [
      _c("p", [
        _vm._v("What? You expected a mobile version? Who do you think I am?")
      ]),
      _vm._v(" "),
      _c("small", [_vm._v("Bloody lazy developers")]),
      _vm._v(" "),
      _c("p", [_vm._v("Go look on a computer fam... Or a really wide phone")]),
      _vm._v(" "),
      _c("div", { staticClass: "lazy-dev" }, [
        _vm._v("🛏️LazyDev"),
        _c("span", [_vm._v("TM")])
      ])
    ])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$3371ec', $3371ec);
          } else {
            api.reload('$3371ec', $3371ec);
          }
        }
...
var _app = _interopRequireDefault(require("./app.component"));
